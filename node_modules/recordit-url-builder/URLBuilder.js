...
Class(Recordit, "URLBuilder")({
    ...
    prototype : {
        ...
        /*
         * Initialize and configure the builder instance
         */
        ...
        /*
         * Main API entry point, receives an object containing the parameters
         * to encode in the URL. Returns the actual URL.
         */
        generate : function generate(paramsObject) {
            var queryString, authenticityToken;

            queryString = this._queryfy(paramsObject);
            authenticityToken = this._signRequest(queryString);

            return this.constructor._protocol + ":" + this.clientID + "-" + authenticityToken + queryString;
        },

        /*
         * Hashes the query string!
         */
        _signRequest : function signRequest(queryString) {
          return Sha1.hash(this.secret + queryString);
        },

        /*
         * Given the params object, converts it to a url encoded
         * query string.
         */
        _queryfy : function queryfy(paramsObject) {
            var queryArray, property, encodedProprety, encodedValue;

            queryArray = [];

            for (property in paramsObject) {
                if (paramsObject.hasOwnProperty(property)) {
                    encodedProperty = encodeURIComponent(property);
                    encodedValue = encodeURIComponent(paramsObject[property]);
                    queryArray.push(encodedProperty + "=" + encodedValue);
                }
            }
...
/*
 * Embedded dependency follows! For more information on this script, please
 * head to http://www.movable-type.co.uk/scripts/sha1.html
 */
